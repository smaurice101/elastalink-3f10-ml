...
.. list-table::
   ...
   * - modelsearchtuner
     - 90
   * - processlogic
     - classification_name=failure_prob:CPULoad_preprocessed_Avg=90,n
   * - dependentvariable
     - failure
   * - independentvariables
     - CPULoad_preprocessed_Avg
   * - rollbackoffsets
     - 1200
   * - topicid
     - -999
...
.. list-table::
   ...
   * - dashboardhtml
     - iot-failure-machinelearning-elastalink.html
   * - secure
     - 1
   * - offset
     - -1
