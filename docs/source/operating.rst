[elastalink-3f10-ml] Operating Details
====================================

Generated On: 2025-02-14 14:15:58 UTC
...
.. important::
   ...
   **not be valid if your [elastalink-3f10-ml] container is NOT running**.

.. tip::
   You must have your [elastalink-3f10-ml] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   http://localhost:49689/iot-failure-machinelearning-elastalink.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   maadsdocker/elastalink-3f10-ml-amd64 (https://hub.docker.com/r/maadsdocker/elastalink-3f10-ml-amd64)
...
.. code-block::
   ...
   docker run -d -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=elastalink-3f10-ml \
          --env SOLUTIONDAG=solution_preprocessing_ml_dag-elastalink-3f10 \
          ...
          maadsdocker/elastalink-3f10-ml-amd64
...
[elastalink-3f10-ml] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/elastalink-3f10-ml
...
.. important::
   https://elastalink-3f10-ml.readthedocs.io
...
.. important::
   solution_preprocessing_ml_dag-elastalink-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=32787, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=39761, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46731, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34857, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40109, HPDEHOST=127.0.1.1, HPDEPORT=37997, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44805

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3710-elastalink-3f10-ml,solution_preprocessing_ml_dag-elastalink-3f10, python-preprocess-1153-elastalink-3f10-ml,solution_preprocessing_ml_dag-elastalink-3f10, python-ml-2879-elastalink-3f10-ml,solution_preprocessing_ml_dag-elastalink-3f10, python-predict-7158-elastalink-3f10-ml,solution_preprocessing_ml_dag-elastalink-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
